...
import fly.speedmeter.grub.MainActivity;
...
//                this.startActivity(intentsensor);
//            case R.id.langutude:
//                Intent intetnLangutude=new Intent(this, LangutudeActivity.class);
//                this.startActivity(intetnLangutude);
